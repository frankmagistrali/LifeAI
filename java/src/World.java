...
//    static         int     WATER = -1;
//    // static int n = 100;
//    private static int[][] land  = new int[worldSizeLength][worldSizeLength];
//    int start = 100;
...
//                                && (breedDir == "w" || water)) {
//                                land[i - 1][j] = 1;
//                            } else if (i < worldSizeLength - 1 && land[i + 1][j] == 0
//                                       && (breedDir == "e" || water)) {
//                                land[i + 1][j] = 1;
//                            } else if (j > 0 && land[i][j - 1] == 0
//                                       && (breedDir == "n" || water)) {
//                                land[i][j - 1] = 1;
//                            } else if (j < worldSizeLength - 1 && land[i][j + 1] == 0
//                                       && (breedDir == "s" || water)) {
//                                land[i][j + 1] = 1;
//                            } else if (i > 0 && j < worldSizeLength - 1
//                                       && land[i - 1][j + 1] == 0
//                                       && (breedDir == "sw " || water)) {
//                                land[i - 1][j + 1] = 1;
//                            } else if (i > 0 && j > 0
...
//                                       && (breedDir == "nw" || water)) {
//                                land[i - 1][j - 1] = 1;
//                            } else if (i < worldSizeLength - 1 && j < worldSizeLength - 1
//                                       && land[i + 1][j + 1] == 0
//                                       && (breedDir == "se" || water)) {
//                                land[i + 1][j + 1] = 1;
//                            } else if (i < worldSizeLength - 1 && j > 0
//                                       && land[i + 1][j - 1] == 0
//                                       && (breedDir == "ne" || water)) {
//                                land[i + 1][j - 1] = 1;
//                            }
